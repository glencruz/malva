                ...
                <div class="row justify-content-between">
                    ...
                    <div class="user-icon d-none d-md-block ">
                        ...
                        <div class="dropdown" style="display: inline;">
                            <a class="btn " style="background-color: transparent; border-color: transparent;" href="#"
                                role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true"
                                aria-expanded="false">
                                <img src="<?=RUTA?>sprites/user.svg" alt="" class="regular-logo">
                                <img src="<?=RUTA?>sprites/down.svg" alt="" class="regular-logo"
                                    style="max-height: 20px; margin: 10% 0 0 -80%;">
                            </a>
                            <a class="paragraph lila">Hola
                                <?php 
                            ...
                            <div class="paragraph morado dropdown-menu" aria-labelledby="dropdownMenuLink">
                                <a class="dropdown-item" id="IRsesion" href="login.php"
                                    style="display: inline-block;">Iniciar Sesión/ Registrarse</a>
                                <a class="dropdown-item" href="#">Pedidos</a>
                                <a class="dropdown-item" id="Csesion" href="cerrarsesision.php"
                                    style="display: inline-block;">Cerrar Sesión</a>
...
<div class="collapse d-block" id="navbarToggleExternalContent">
    <div class="row justify-content-end links title v2 white text-right flex-column">
        ...
        <div class="social-icons">
            ...
            <a target="_blank" href="https://www.facebook.com/malvastudi0"><img
                    src="<?php echo RUTA ?>sprites/facebook.svg" alt=""></a>


            <a target="_blank" href="https://www.instagram.com/malvastudio_/"><img
                    src="<?php echo RUTA ?>sprites/instagram.svg" alt=""></a>

        </div>
        <div class="social-icons d-block d-md-none w-100">

            <a target="_blank" href="#"><img style="max-height:40px;" src="<?php echo RUTA ?>sprites/carrito.svg"
                    alt=""></a>
            <a target="_blank" href="#"><img style="max-height:40px;" src="<?php echo RUTA ?>sprites/user.svg"
                    alt=""></a>
        </div>
